...
The website is built with R  website bulider and rmd files to share data insights, visualizations, and interactive maps with the malaria research community.
